...
```
1. If ANY finding has severity DANGER → NO-GO
2. If total score >= nogo_score (default 60) → NO-GO
...
or all checks failed. Same exit code as NO-GO — treat as "do not proceed."
